...
export async function listFeaturedAppsVoByPage(
  body: API.AppQueryRequest,
  options?: { [key: string]: any }
) {
...
/** 此处后端没有提供注释 POST /app/list/user/page/vo */
export async function listUserAppsVoByPage(
  body: API.AppQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageAppVO>('/app/list/user/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
